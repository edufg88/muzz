...
int main(int argc, char *argv[])
{
    ...
    printf("======================================================================\n");
    printf("Info-only Event Example.  Copyright (c) Firelight Technologies 2004-2010.\n");
    printf("==============================-------=================================\n");
    ...
    do
    {
        if (_kbhit())
        {
            ...
            if (key == 'i')
            {
                 ...
                 */
                ERRCHECK(result = eventgroup->getEvent("SimpleEventWithLooping", FMOD_EVENT_INFOONLY, &event));
            ...
            else if (key == 'e')
            {
                 ...
                 */
                ERRCHECK(result = eventgroup->getEvent("SimpleEventWithLooping", FMOD_EVENT_DEFAULT, &event));
